          ...
          <div className="flex flex-col gap-6">
            ...
            <ul className="flex flex-col gap-4 font-inter md:font-medium font-normal md:text-sm text-xs">
              ...
              <Link to="/terms-and-conditions">
                <li className="hover:text-orange-300">Terms and conditions</li>
              </Link>
              <Link to="/privacy-policy">
                <li className="hover:text-orange-300">Privacy Policy</li>
              </Link>
            </ul>
          </div>
          <div className="flex flex-col gap-6">
            ...
            <ul className="flex flex-col gap-4 font-inter md:font-medium font-normal md:text-sm text-xs">
              <Link to="/events">
                <li className="hover:text-orange-300">Event</li>
              </Link>
              <Link to="/blog">
                <li className="hover:text-orange-300">News</li>
              </Link>
              <Link to="/faq">
                <li className="hover:text-orange-300">FAQs</li>
              </Link>
            </ul>
          </div>
          <div className="flex flex-col gap-6">
            ...
            <ul className="flex flex-col gap-4 font-inter md:font-medium font-normal md:text-sm text-xs">
              <Link to="/create">
                <li className="hover:text-orange-300">Create event</li>
              </Link>
              <Link to="/contact">
                <li className="hover:text-orange-300">Contact Support</li>
              </Link>
              <Link to="/reviews">
                <li className="hover:text-orange-300">Ratings and reviews</li>
              </Link>
            </ul>
          </div>
        </div>
