...
import { MdOutlineEventNote, MdCreateNewFolder, MdEventBusy } from "react-icons/md";
                ...
                <Link to={route} key={index} onClick={onClose}>
                  <li
                    className={`flex items-center gap-3 px-4 py-2 rounded-lg cursor-pointer text-sm sm:text-base transition-all duration-300 ${
                      isActive ? "bg-orange-100 text-gray-900 font-semibold" : "hover:bg-orange-200 text-gray-800"
                    }`}
                  >
                    <Icon size={18} />
                    {title}
