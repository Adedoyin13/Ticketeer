...
const TicketPage = () => {
  ...
  return (
    <div className="flex justify-center items-center w-full min-h-screen bg-orange-50 dark:bg-zinc-950 px-4 py-8 font-inter">
      <div className="w-full max-w-3xl p-6 bg-white dark:bg-zinc-900 rounded-2xl shadow-xl">
        <h2 className="text-3xl font-bold mb-6 text-zinc-800 dark:text-white">
          🎟️ Your Ticket
        </h2>

        <div className="border border-zinc-200 dark:border-zinc-700 bg-orange-50 dark:bg-zinc-800 rounded-xl p-6 grid gap-6 md:grid-cols-2">
          {/* QR Code */}
