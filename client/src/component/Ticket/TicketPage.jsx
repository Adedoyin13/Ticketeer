...
const TicketPage = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-orange-50 dark:bg-zinc-950 px-4 py-8 font-inter flex flex-col items-center">
      {/* Back button at top left */}
      <div className="w-full max-w-md mb-4">
        <button
          onClick={handleBack}
          className="text-gray-500 dark:text-zinc-400 hover:text-gray-700 dark:hover:text-zinc-200 transition-colors"
        >
          <FaArrowLeft size={20} />
        </button>
      </div>
